...
export class DirectedImpactors extends Card implements IActionCard, IProjectCard {
  ...
  public canAct(player: IPlayer): boolean {
    ...
    if (player.game.getTemperature() === player.game.gameOptions.maxTemperature && cardHasResources) return true;
  ...
  public action(player: IPlayer) {
    ...
    const temperatureIsMaxed = player.game.getTemperature() === player.game.gameOptions.maxTemperature;
